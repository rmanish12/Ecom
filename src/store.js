...
export default new Vuex.Store({
  state: {
    products: [
      ...
      {
        id: 6,
        title: 'Sony PS4 500 GB Slim Console',
        image: '/static/images/ps4.jpg',
        description: ['Bundle with 3 HIT games and PlayStation plus 3 month membership',
          'New attractive black colour PS4 with similar colour of controller, amazing HDR quality graphics',
          '30 percent slimmer, 16 percent lighter than earlier PS4 model',
          'Store your games, apps, screenshots and videos'],
        price: 50,
        ratings: 3,
        reviews: 5,
        isAddedToCart: false,
      ...
      {
        id: 9,
        title: 'Sony BDV-N7200W Real 5.1ch Dolby Digital 4K Wireless Blu-ray Home Theatre System',
        image: '/static/images/sony_home_theatre.jpg',
        description: ['Power Output – 1200 Watts',
          'New India sound setting ”ClearAudio+”',
          '2way satellite speaker',
          'Bluetooth + NFC'],
        price: 650,
        ratings: 3,
        reviews: 5,
